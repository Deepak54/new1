...
<div class="center">
   ...
   <h1 style="color:darkblue;">Best Seller Books</h1>
    ...
    <div class="row">
        ...
        <div class="col-sm-4">
            <div class="panel panel-danger">
                ...
                <div class="panel-footer">Rs 110/-</div>
            </div>
        </div>
        <div class="col-sm-4">
            <div class="panel panel-success">
                ...
                <div class="panel-footer">Rs 130/-</div>
            </div>
        </div>
    </div>
</div><br>
    ...
    <div class="row">
        <div class="col-sm-4">
            <div class="panel panel-primary">
                ...
                <div class="panel-footer">Rs 325/-</div>
            </div>
        </div>
        <div class="col-sm-4">
            <div class="panel panel-primary">
                ...
                <div class="panel-footer">280/-</div>
            </div>
        </div>
        <div class="col-sm-4">
            <div class="panel panel-primary">
